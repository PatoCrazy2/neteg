        ...
        <div className="flex-1 flex items-center justify-center px-6 sm:px-12 pb-12">
          <div className="w-full max-w-[400px] space-y-8">
            <div>
              ...
              <p className="mt-2 text-zinc-500 text-sm">Inicia sesión con Google para continuar:</p>
            </div>

            {/* Botón de Google Oficial con estilo ajustado */}
            <div className="flex justify-center w-full">
              <GoogleLogin
                onSuccess={handleGoogleSuccess}
                onError={() => setErrors({ server: "Error en el login de Google" })}
                theme="filled_black"
                shape="rectangular"
                width="400"
              />
