        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 mb-24">
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <div className="flex items-center gap-6 pt-2">
              <Link href="https://github.com" className="text-white/30 hover:text-white transition-colors" aria-label="GitHub">
        ...
        <div className="pt-12 border-t border-white/[0.03] flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2 group cursor-default">
               <span className="text-[9px] uppercase tracking-[0.3em] text-white/10 group-hover:text-white/30 transition-colors">
                PatoCrazy2
               </span>
            </div>
